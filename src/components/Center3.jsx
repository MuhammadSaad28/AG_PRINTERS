...
function Center3({ rgp1, po1, articleName1, quantity1, rate1, amount1,rgp2, po2, articleName2, quantity2, rate2, amount2,rgp3, po3, articleName3, quantity3, rate3, amount3}) {
  return (
    <div className="">
