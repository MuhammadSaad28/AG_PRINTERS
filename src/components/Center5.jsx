...
function Center5({ rgp1, po1, articleName1, quantity1, rate1, amount1,rgp2, po2, articleName2, quantity2, rate2, amount2,rgp3, po3, articleName3, quantity3, rate3, amount3,rgp4, po4, articleName4, quantity4, rate4, amount4,rgp5, po5, articleName5, quantity5, rate5, amount5}) {
  return (
    <div className="">
...
<th scope="row" className="border border-dark text-center">5</th>
<td className="border border-dark ">RGP # {rgp5}</td>
<td className="border border-dark"></td>
<td className="border border-dark"></td>
<td className="border border-dark"></td>
</tr>
...
<th scope="row" className="border border-dark"></th>
<td className="border border-dark ">PO # {po5}</td>
<td className="border border-dark"></td>
<td className="border border-dark"></td>
<td className="border border-dark"></td>
</tr>
...
<th scope="row" className="border border-dark"></th>
<td className="border border-dark ">{articleName5}</td>
<td className="border border-dark text-center">{quantity5} mtr</td>
<td className="border border-dark text-center">Rs {rate5}/-</td>
<td className="border border-dark text-center">{amount5}/-</td>
</tr>
        <tr style={{ height: '2.5rem' }}>
